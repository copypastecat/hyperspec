...
sampled_vals_water = this_ideal_sensor.sample(new_specs[0],samplingpoints=[100,300,450])
sampled_vals_sand = this_ideal_sensor.sample(new_specs[1],samplingpoints=[100,300,450])
...
sampled_observation = this_sensor.sample(mixture,samplingpoints=[100,300,450])
